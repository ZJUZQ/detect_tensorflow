...
from lib.core import prefetcher
...
class BatchQueue(object):
	...
	def __init__(self, tensor_dict, batch_size, batch_queue_capacity,
		...
		Args:
			tensor_dict: dictionary of tensors to batch, one queue element
		...
		self._queue = prefetcher.prefetch(tensor_dict=batched_tensors,
