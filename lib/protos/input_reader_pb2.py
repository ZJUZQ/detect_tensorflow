...
# source: lib/protos/input_reader.proto
...
_INPUTREADER = _descriptor.Descriptor(
  name='InputReader',
  full_name='lib.protos.InputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='label_map_path', full_name='lib.protos.InputReader.label_map_path', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='shuffle', full_name='lib.protos.InputReader.shuffle', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='shuffle_buffer_size', full_name='lib.protos.InputReader.shuffle_buffer_size', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='filenames_shuffle_buffer_size', full_name='lib.protos.InputReader.filenames_shuffle_buffer_size', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='queue_capacity', full_name='lib.protos.InputReader.queue_capacity', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_after_dequeue', full_name='lib.protos.InputReader.min_after_dequeue', index=5,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_epochs', full_name='lib.protos.InputReader.num_epochs', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_readers', full_name='lib.protos.InputReader.num_readers', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='read_block_length', full_name='lib.protos.InputReader.read_block_length', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='prefetch_size', full_name='lib.protos.InputReader.prefetch_size', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_parallel_map_calls', full_name='lib.protos.InputReader.num_parallel_map_calls', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='num_keypoints', full_name='lib.protos.InputReader.num_keypoints', index=11,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='load_instance_masks', full_name='lib.protos.InputReader.load_instance_masks', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mask_type', full_name='lib.protos.InputReader.mask_type', index=13,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='tf_record_input_reader', full_name='lib.protos.InputReader.tf_record_input_reader', index=14,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='external_input_reader', full_name='lib.protos.InputReader.external_input_reader', index=15,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='input_reader', full_name='lib.protos.InputReader.input_reader',
...
_TFRECORDINPUTREADER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.TFRecordInputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='input_path', full_name='lib.protos.TFRecordInputReader.input_path', index=0,
...
_EXTERNALINPUTREADER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.ExternalInputReader',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
InputReader = _reflection.GeneratedProtocolMessageType('InputReader', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.InputReader)
  ))
...
TFRecordInputReader = _reflection.GeneratedProtocolMessageType('TFRecordInputReader', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.TFRecordInputReader)
  ))
...
ExternalInputReader = _reflection.GeneratedProtocolMessageType('ExternalInputReader', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.input_reader_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.ExternalInputReader)
  ))
