...
# source: lib/protos/losses.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lib/protos/losses.proto',
  package='lib.protos',
  syntax='proto2',
  serialized_pb=_b('\n\x17lib/protos/losses.proto\x12\nlib.protos\"\xba\x02\n\x04Loss\x12\x37\n\x11localization_loss\x18\x01 \x01(\x0b\x32\x1c.lib.protos.LocalizationLoss\x12;\n\x13\x63lassification_loss\x18\x02 \x01(\x0b\x32\x1e.lib.protos.ClassificationLoss\x12\x38\n\x12hard_example_miner\x18\x03 \x01(\x0b\x32\x1c.lib.protos.HardExampleMiner\x12 \n\x15\x63lassification_weight\x18\x04 \x01(\x02:\x01\x31\x12\x1e\n\x13localization_weight\x18\x05 \x01(\x02:\x01\x31\x12@\n\x16random_example_sampler\x18\x06 \x01(\x0b\x32 .lib.protos.RandomExampleSampler\"\xf3\x01\n\x10LocalizationLoss\x12=\n\x0bweighted_l2\x18\x01 \x01(\x0b\x32&.lib.protos.WeightedL2LocalizationLossH\x00\x12J\n\x12weighted_smooth_l1\x18\x02 \x01(\x0b\x32,.lib.protos.WeightedSmoothL1LocalizationLossH\x00\x12?\n\x0cweighted_iou\x18\x03 \x01(\x0b\x32\'.lib.protos.WeightedIOULocalizationLossH\x00\x42\x13\n\x11localization_loss\">\n\x1aWeightedL2LocalizationLoss\x12 \n\x11\x61nchorwise_output\x18\x01 \x01(\x08:\x05\x66\x61lse\"V\n WeightedSmoothL1LocalizationLoss\x12 \n\x11\x61nchorwise_output\x18\x01 \x01(\x08:\x05\x66\x61lse\x12\x10\n\x05\x64\x65lta\x18\x02 \x01(\x02:\x01\x31\"\x1d\n\x1bWeightedIOULocalizationLoss\"\xc1\x03\n\x12\x43lassificationLoss\x12I\n\x10weighted_sigmoid\x18\x01 \x01(\x0b\x32-.lib.protos.WeightedSigmoidClassificationLossH\x00\x12I\n\x10weighted_softmax\x18\x02 \x01(\x0b\x32-.lib.protos.WeightedSoftmaxClassificationLossH\x00\x12]\n\x17weighted_logits_softmax\x18\x05 \x01(\x0b\x32:.lib.protos.WeightedSoftmaxClassificationAgainstLogitsLossH\x00\x12Q\n\x14\x62ootstrapped_sigmoid\x18\x03 \x01(\x0b\x32\x31.lib.protos.BootstrappedSigmoidClassificationLossH\x00\x12L\n\x16weighted_sigmoid_focal\x18\x04 \x01(\x0b\x32*.lib.protos.SigmoidFocalClassificationLossH\x00\x42\x15\n\x13\x63lassification_loss\"E\n!WeightedSigmoidClassificationLoss\x12 \n\x11\x61nchorwise_output\x18\x01 \x01(\x08:\x05\x66\x61lse\"c\n\x1eSigmoidFocalClassificationLoss\x12 \n\x11\x61nchorwise_output\x18\x01 \x01(\x08:\x05\x66\x61lse\x12\x10\n\x05gamma\x18\x02 \x01(\x02:\x01\x32\x12\r\n\x05\x61lpha\x18\x03 \x01(\x02\"]\n!WeightedSoftmaxClassificationLoss\x12 \n\x11\x61nchorwise_output\x18\x01 \x01(\x08:\x05\x66\x61lse\x12\x16\n\x0blogit_scale\x18\x02 \x01(\x02:\x01\x31\"j\n.WeightedSoftmaxClassificationAgainstLogitsLoss\x12 \n\x11\x61nchorwise_output\x18\x01 \x01(\x08:\x05\x66\x61lse\x12\x16\n\x0blogit_scale\x18\x02 \x01(\x02:\x01\x31\"w\n%BootstrappedSigmoidClassificationLoss\x12\r\n\x05\x61lpha\x18\x01 \x01(\x02\x12\x1d\n\x0ehard_bootstrap\x18\x02 \x01(\x08:\x05\x66\x61lse\x12 \n\x11\x61nchorwise_output\x18\x03 \x01(\x08:\x05\x66\x61lse\"\x94\x02\n\x10HardExampleMiner\x12\x1d\n\x11num_hard_examples\x18\x01 \x01(\x05:\x02\x36\x34\x12\x1a\n\riou_threshold\x18\x02 \x01(\x02:\x03\x30.7\x12>\n\tloss_type\x18\x03 \x01(\x0e\x32%.lib.protos.HardExampleMiner.LossType:\x04\x42OTH\x12%\n\x1amax_negatives_per_positive\x18\x04 \x01(\x05:\x01\x30\x12\"\n\x17min_negatives_per_image\x18\x05 \x01(\x05:\x01\x30\":\n\x08LossType\x12\x08\n\x04\x42OTH\x10\x00\x12\x12\n\x0e\x43LASSIFICATION\x10\x01\x12\x10\n\x0cLOCALIZATION\x10\x02\">\n\x14RandomExampleSampler\x12&\n\x18positive_sample_fraction\x18\x01 \x01(\x02:\x04\x30.01')
)
...
_HARDEXAMPLEMINER_LOSSTYPE = _descriptor.EnumDescriptor(
  name='LossType',
  full_name='lib.protos.HardExampleMiner.LossType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_LOSS = _descriptor.Descriptor(
  name='Loss',
  full_name='lib.protos.Loss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='localization_loss', full_name='lib.protos.Loss.localization_loss', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='classification_loss', full_name='lib.protos.Loss.classification_loss', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hard_example_miner', full_name='lib.protos.Loss.hard_example_miner', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='classification_weight', full_name='lib.protos.Loss.classification_weight', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='localization_weight', full_name='lib.protos.Loss.localization_weight', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='random_example_sampler', full_name='lib.protos.Loss.random_example_sampler', index=5,
...
_LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.LocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weighted_l2', full_name='lib.protos.LocalizationLoss.weighted_l2', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weighted_smooth_l1', full_name='lib.protos.LocalizationLoss.weighted_smooth_l1', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weighted_iou', full_name='lib.protos.LocalizationLoss.weighted_iou', index=2,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='localization_loss', full_name='lib.protos.LocalizationLoss.localization_loss',
...
_WEIGHTEDL2LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.WeightedL2LocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.WeightedL2LocalizationLoss.anchorwise_output', index=0,
...
_WEIGHTEDSMOOTHL1LOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.WeightedSmoothL1LocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.WeightedSmoothL1LocalizationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='delta', full_name='lib.protos.WeightedSmoothL1LocalizationLoss.delta', index=1,
...
_WEIGHTEDIOULOCALIZATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.WeightedIOULocalizationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_CLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.ClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='weighted_sigmoid', full_name='lib.protos.ClassificationLoss.weighted_sigmoid', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weighted_softmax', full_name='lib.protos.ClassificationLoss.weighted_softmax', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weighted_logits_softmax', full_name='lib.protos.ClassificationLoss.weighted_logits_softmax', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='bootstrapped_sigmoid', full_name='lib.protos.ClassificationLoss.bootstrapped_sigmoid', index=3,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='weighted_sigmoid_focal', full_name='lib.protos.ClassificationLoss.weighted_sigmoid_focal', index=4,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='classification_loss', full_name='lib.protos.ClassificationLoss.classification_loss',
      index=0, containing_type=None, fields=[]),
  ],
...
_WEIGHTEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.WeightedSigmoidClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.WeightedSigmoidClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_SIGMOIDFOCALCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.SigmoidFocalClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.SigmoidFocalClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='gamma', full_name='lib.protos.SigmoidFocalClassificationLoss.gamma', index=1,
      number=2, type=2, cpp_type=6, label=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='alpha', full_name='lib.protos.SigmoidFocalClassificationLoss.alpha', index=2,
...
_WEIGHTEDSOFTMAXCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.WeightedSoftmaxClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.WeightedSoftmaxClassificationLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='logit_scale', full_name='lib.protos.WeightedSoftmaxClassificationLoss.logit_scale', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WEIGHTEDSOFTMAXCLASSIFICATIONAGAINSTLOGITSLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.WeightedSoftmaxClassificationAgainstLogitsLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.WeightedSoftmaxClassificationAgainstLogitsLoss.anchorwise_output', index=0,
      number=1, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='logit_scale', full_name='lib.protos.WeightedSoftmaxClassificationAgainstLogitsLoss.logit_scale', index=1,
      number=2, type=2, cpp_type=6, label=1,
      has_default_value=True, default_value=float(1),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BOOTSTRAPPEDSIGMOIDCLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  full_name='lib.protos.BootstrappedSigmoidClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='alpha', full_name='lib.protos.BootstrappedSigmoidClassificationLoss.alpha', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='hard_bootstrap', full_name='lib.protos.BootstrappedSigmoidClassificationLoss.hard_bootstrap', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='lib.protos.BootstrappedSigmoidClassificationLoss.anchorwise_output', index=2,
...
_HARDEXAMPLEMINER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.HardExampleMiner',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='num_hard_examples', full_name='lib.protos.HardExampleMiner.num_hard_examples', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='iou_threshold', full_name='lib.protos.HardExampleMiner.iou_threshold', index=1,
      number=2, type=2, cpp_type=6, label=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='loss_type', full_name='lib.protos.HardExampleMiner.loss_type', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_negatives_per_positive', full_name='lib.protos.HardExampleMiner.max_negatives_per_positive', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_negatives_per_image', full_name='lib.protos.HardExampleMiner.min_negatives_per_image', index=4,
...
_RANDOMEXAMPLESAMPLER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.RandomExampleSampler',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='positive_sample_fraction', full_name='lib.protos.RandomExampleSampler.positive_sample_fraction', index=0,
      number=1, type=2, cpp_type=6, label=1,
...
Loss = _reflection.GeneratedProtocolMessageType('Loss', (_message.Message,), dict(
  DESCRIPTOR = _LOSS,
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.Loss)
  ))
...
LocalizationLoss = _reflection.GeneratedProtocolMessageType('LocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.LocalizationLoss)
  ))
...
WeightedL2LocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedL2LocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.WeightedL2LocalizationLoss)
  ))
...
WeightedSmoothL1LocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedSmoothL1LocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.WeightedSmoothL1LocalizationLoss)
  ))
...
WeightedIOULocalizationLoss = _reflection.GeneratedProtocolMessageType('WeightedIOULocalizationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.WeightedIOULocalizationLoss)
  ))
...
ClassificationLoss = _reflection.GeneratedProtocolMessageType('ClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.ClassificationLoss)
  ))
...
WeightedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedSigmoidClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.WeightedSigmoidClassificationLoss)
  ))
...
SigmoidFocalClassificationLoss = _reflection.GeneratedProtocolMessageType('SigmoidFocalClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.SigmoidFocalClassificationLoss)
  ))
...
WeightedSoftmaxClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedSoftmaxClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.WeightedSoftmaxClassificationLoss)
  ))
...
WeightedSoftmaxClassificationAgainstLogitsLoss = _reflection.GeneratedProtocolMessageType('WeightedSoftmaxClassificationAgainstLogitsLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.WeightedSoftmaxClassificationAgainstLogitsLoss)
  ))
...
BootstrappedSigmoidClassificationLoss = _reflection.GeneratedProtocolMessageType('BootstrappedSigmoidClassificationLoss', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.BootstrappedSigmoidClassificationLoss)
  ))
...
HardExampleMiner = _reflection.GeneratedProtocolMessageType('HardExampleMiner', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.HardExampleMiner)
  ))
...
RandomExampleSampler = _reflection.GeneratedProtocolMessageType('RandomExampleSampler', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.RandomExampleSampler)
  ))
