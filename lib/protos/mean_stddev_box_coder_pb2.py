...
# source: lib/protos/mean_stddev_box_coder.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lib/protos/mean_stddev_box_coder.proto',
  package='lib.protos',
  syntax='proto2',
  serialized_pb=_b('\n&lib/protos/mean_stddev_box_coder.proto\x12\nlib.protos\"*\n\x12MeanStddevBoxCoder\x12\x14\n\x06stddev\x18\x01 \x01(\x02:\x04\x30.01')
)
...
_MEANSTDDEVBOXCODER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.MeanStddevBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='stddev', full_name='lib.protos.MeanStddevBoxCoder.stddev', index=0,
...
MeanStddevBoxCoder = _reflection.GeneratedProtocolMessageType('MeanStddevBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.mean_stddev_box_coder_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.MeanStddevBoxCoder)
  ))
