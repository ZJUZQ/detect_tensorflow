...
# source: lib/protos/square_box_coder.proto
...
_SQUAREBOXCODER = _descriptor.Descriptor(
  name='SquareBoxCoder',
  full_name='lib.protos.SquareBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='lib.protos.SquareBoxCoder.y_scale', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='x_scale', full_name='lib.protos.SquareBoxCoder.x_scale', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='length_scale', full_name='lib.protos.SquareBoxCoder.length_scale', index=2,
...
SquareBoxCoder = _reflection.GeneratedProtocolMessageType('SquareBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.square_box_coder_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.SquareBoxCoder)
  ))
