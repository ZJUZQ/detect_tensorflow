...
# source: lib/protos/post_processing.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lib/protos/post_processing.proto',
  package='lib.protos',
  syntax='proto2',
  serialized_pb=_b('\n lib/protos/post_processing.proto\x12\nlib.protos\"\x9a\x01\n\x16\x42\x61tchNonMaxSuppression\x12\x1a\n\x0fscore_threshold\x18\x01 \x01(\x02:\x01\x30\x12\x1a\n\riou_threshold\x18\x02 \x01(\x02:\x03\x30.6\x12%\n\x18max_detections_per_class\x18\x03 \x01(\x05:\x03\x31\x30\x30\x12!\n\x14max_total_detections\x18\x05 \x01(\x05:\x03\x31\x30\x30\"\xf7\x01\n\x0ePostProcessing\x12\x45\n\x19\x62\x61tch_non_max_suppression\x18\x01 \x01(\x0b\x32\".lib.protos.BatchNonMaxSuppression\x12L\n\x0fscore_converter\x18\x02 \x01(\x0e\x32).lib.protos.PostProcessing.ScoreConverter:\x08IDENTITY\x12\x16\n\x0blogit_scale\x18\x03 \x01(\x02:\x01\x31\"8\n\x0eScoreConverter\x12\x0c\n\x08IDENTITY\x10\x00\x12\x0b\n\x07SIGMOID\x10\x01\x12\x0b\n\x07SOFTMAX\x10\x02')
)
...
_POSTPROCESSING_SCORECONVERTER = _descriptor.EnumDescriptor(
  name='ScoreConverter',
  full_name='lib.protos.PostProcessing.ScoreConverter',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_BATCHNONMAXSUPPRESSION = _descriptor.Descriptor(
  ...
  full_name='lib.protos.BatchNonMaxSuppression',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='score_threshold', full_name='lib.protos.BatchNonMaxSuppression.score_threshold', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='iou_threshold', full_name='lib.protos.BatchNonMaxSuppression.iou_threshold', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_detections_per_class', full_name='lib.protos.BatchNonMaxSuppression.max_detections_per_class', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_total_detections', full_name='lib.protos.BatchNonMaxSuppression.max_total_detections', index=3,
...
_POSTPROCESSING = _descriptor.Descriptor(
  name='PostProcessing',
  full_name='lib.protos.PostProcessing',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='batch_non_max_suppression', full_name='lib.protos.PostProcessing.batch_non_max_suppression', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='score_converter', full_name='lib.protos.PostProcessing.score_converter', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='logit_scale', full_name='lib.protos.PostProcessing.logit_scale', index=2,
...
BatchNonMaxSuppression = _reflection.GeneratedProtocolMessageType('BatchNonMaxSuppression', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.post_processing_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.BatchNonMaxSuppression)
  ))
...
PostProcessing = _reflection.GeneratedProtocolMessageType('PostProcessing', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.post_processing_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.PostProcessing)
  ))
