...
# source: lib/protos/faster_rcnn_box_coder.proto
...
_FASTERRCNNBOXCODER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.FasterRcnnBoxCoder',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='y_scale', full_name='lib.protos.FasterRcnnBoxCoder.y_scale', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='x_scale', full_name='lib.protos.FasterRcnnBoxCoder.x_scale', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height_scale', full_name='lib.protos.FasterRcnnBoxCoder.height_scale', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width_scale', full_name='lib.protos.FasterRcnnBoxCoder.width_scale', index=3,
...
FasterRcnnBoxCoder = _reflection.GeneratedProtocolMessageType('FasterRcnnBoxCoder', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.faster_rcnn_box_coder_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.FasterRcnnBoxCoder)
  ))
