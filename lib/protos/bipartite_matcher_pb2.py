...
# source: lib/protos/bipartite_matcher.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lib/protos/bipartite_matcher.proto',
  package='lib.protos',
  syntax='proto2',
  serialized_pb=_b('\n\"lib/protos/bipartite_matcher.proto\x12\nlib.protos\"4\n\x10\x42ipartiteMatcher\x12 \n\x11use_matmul_gather\x18\x06 \x01(\x08:\x05\x66\x61lse')
)
...
_BIPARTITEMATCHER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.BipartiteMatcher',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='use_matmul_gather', full_name='lib.protos.BipartiteMatcher.use_matmul_gather', index=0,
...
BipartiteMatcher = _reflection.GeneratedProtocolMessageType('BipartiteMatcher', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.bipartite_matcher_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.BipartiteMatcher)
  ))
