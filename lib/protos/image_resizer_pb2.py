...
# source: lib/protos/image_resizer.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lib/protos/image_resizer.proto',
  package='lib.protos',
  syntax='proto2',
  serialized_pb=_b('\n\x1elib/protos/image_resizer.proto\x12\nlib.protos\"\xac\x01\n\x0cImageResizer\x12G\n\x19keep_aspect_ratio_resizer\x18\x01 \x01(\x0b\x32\".lib.protos.KeepAspectRatioResizerH\x00\x12<\n\x13\x66ixed_shape_resizer\x18\x02 \x01(\x0b\x32\x1d.lib.protos.FixedShapeResizerH\x00\x42\x15\n\x13image_resizer_oneof\"\xd4\x01\n\x16KeepAspectRatioResizer\x12\x1a\n\rmin_dimension\x18\x01 \x01(\x05:\x03\x36\x30\x30\x12\x1b\n\rmax_dimension\x18\x02 \x01(\x05:\x04\x31\x30\x32\x34\x12\x37\n\rresize_method\x18\x03 \x01(\x0e\x32\x16.lib.protos.ResizeType:\x08\x42ILINEAR\x12#\n\x14pad_to_max_dimension\x18\x04 \x01(\x08:\x05\x66\x61lse\x12#\n\x14\x63onvert_to_grayscale\x18\x05 \x01(\x08:\x05\x66\x61lse\"\x9a\x01\n\x11\x46ixedShapeResizer\x12\x13\n\x06height\x18\x01 \x01(\x05:\x03\x33\x30\x30\x12\x12\n\x05width\x18\x02 \x01(\x05:\x03\x33\x30\x30\x12\x37\n\rresize_method\x18\x03 \x01(\x0e\x32\x16.lib.protos.ResizeType:\x08\x42ILINEAR\x12#\n\x14\x63onvert_to_grayscale\x18\x04 \x01(\x08:\x05\x66\x61lse*G\n\nResizeType\x12\x0c\n\x08\x42ILINEAR\x10\x00\x12\x14\n\x10NEAREST_NEIGHBOR\x10\x01\x12\x0b\n\x07\x42ICUBIC\x10\x02\x12\x08\n\x04\x41REA\x10\x03')
)

_RESIZETYPE = _descriptor.EnumDescriptor(
  name='ResizeType',
  full_name='lib.protos.ResizeType',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_IMAGERESIZER = _descriptor.Descriptor(
  name='ImageResizer',
  full_name='lib.protos.ImageResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keep_aspect_ratio_resizer', full_name='lib.protos.ImageResizer.keep_aspect_ratio_resizer', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='fixed_shape_resizer', full_name='lib.protos.ImageResizer.fixed_shape_resizer', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='image_resizer_oneof', full_name='lib.protos.ImageResizer.image_resizer_oneof',
...
_KEEPASPECTRATIORESIZER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.KeepAspectRatioResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='min_dimension', full_name='lib.protos.KeepAspectRatioResizer.min_dimension', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_dimension', full_name='lib.protos.KeepAspectRatioResizer.max_dimension', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resize_method', full_name='lib.protos.KeepAspectRatioResizer.resize_method', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='pad_to_max_dimension', full_name='lib.protos.KeepAspectRatioResizer.pad_to_max_dimension', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='convert_to_grayscale', full_name='lib.protos.KeepAspectRatioResizer.convert_to_grayscale', index=4,
...
_FIXEDSHAPERESIZER = _descriptor.Descriptor(
  ...
  full_name='lib.protos.FixedShapeResizer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='height', full_name='lib.protos.FixedShapeResizer.height', index=0,
      number=1, type=5, cpp_type=1, label=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='width', full_name='lib.protos.FixedShapeResizer.width', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=True, default_value=300,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='resize_method', full_name='lib.protos.FixedShapeResizer.resize_method', index=2,
      number=3, type=14, cpp_type=8, label=1,
      has_default_value=True, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='convert_to_grayscale', full_name='lib.protos.FixedShapeResizer.convert_to_grayscale', index=3,
      number=4, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
ImageResizer = _reflection.GeneratedProtocolMessageType('ImageResizer', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.ImageResizer)
  ))
...
KeepAspectRatioResizer = _reflection.GeneratedProtocolMessageType('KeepAspectRatioResizer', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.KeepAspectRatioResizer)
  ))
...
FixedShapeResizer = _reflection.GeneratedProtocolMessageType('FixedShapeResizer', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.image_resizer_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.FixedShapeResizer)
  ))
