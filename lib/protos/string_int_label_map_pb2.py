...
# source: lib/protos/string_int_label_map.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='lib/protos/string_int_label_map.proto',
  package='lib.protos',
  syntax='proto2',
  serialized_pb=_b('\n%lib/protos/string_int_label_map.proto\x12\nlib.protos\"G\n\x15StringIntLabelMapItem\x12\x0c\n\x04name\x18\x01 \x01(\t\x12\n\n\x02id\x18\x02 \x01(\x05\x12\x14\n\x0c\x64isplay_name\x18\x03 \x01(\t\"D\n\x11StringIntLabelMap\x12/\n\x04item\x18\x01 \x03(\x0b\x32!.lib.protos.StringIntLabelMapItem')
)
...
_STRINGINTLABELMAPITEM = _descriptor.Descriptor(
  ...
  full_name='lib.protos.StringIntLabelMapItem',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='lib.protos.StringIntLabelMapItem.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='lib.protos.StringIntLabelMapItem.id', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='display_name', full_name='lib.protos.StringIntLabelMapItem.display_name', index=2,
...
_STRINGINTLABELMAP = _descriptor.Descriptor(
  ...
  full_name='lib.protos.StringIntLabelMap',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='item', full_name='lib.protos.StringIntLabelMap.item', index=0,
...
StringIntLabelMapItem = _reflection.GeneratedProtocolMessageType('StringIntLabelMapItem', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.string_int_label_map_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.StringIntLabelMapItem)
  ))
...
StringIntLabelMap = _reflection.GeneratedProtocolMessageType('StringIntLabelMap', (_message.Message,), dict(
  ...
  __module__ = 'lib.protos.string_int_label_map_pb2'
  # @@protoc_insertion_point(class_scope:lib.protos.StringIntLabelMap)
  ))
